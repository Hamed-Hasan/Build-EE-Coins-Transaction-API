            ...
            <Grid container spacing={3}>
              ...
              >
                ...
                >
                  ...
                  {taskDetails.tasks.description?.length > 140 && !showFullDescription && (
                    <span
              ...
              >
                ...
                >
                  File: {renderDescription(taskDetails.tasks.taskCreatedEmp.fileName)}
                  {taskDetails.tasks.taskCreatedEmp.fileName?.length > 140 && !showFullDescription && (
                    <span
                  ...
                  <a
                    href={`http://207.180.244.205:1085/UploadedFiles/TasksUploads/${taskId}/${encodeURIComponent(taskDetails.tasks.taskCreatedEmp.fileName)}`}
                    target="_blank"
                    style={{ marginLeft: '10px' }}
                  >
                    <CloudDownloadIcon style={{ color: '#706AF6', verticalAlign: 'middle' }} />
                  </a>
                </Typography>
                ...
                <Box sx={{ display: 'flex', flexDirection: 'column', gap: 1 }}>
                  ...
                  <Typography
                    ...
                    sx={{
                      ...
                      color: "white",
                      textTransform: "none",
                      display: taskDetails.tasks.taskCreatedEmp.submittedCount < 1
                        ? 'none'
                        : 'block',
                    }}
                  >
                ...
                <Box sx={{ display: 'flex', flexDirection: 'column', gap: 1 }}>
                  ...
                  <Typography
                    ...
                    sx={{
                      ...
                      color: "white",
                      textTransform: "none",
                      display: taskDetails.tasks.taskAssignedEmp.objectCount < 1
                        ? 'none'
                        : 'block',
                    }}
                  >
                  ...
                  <Typography
                    ...
                    sx={{
                      ...
                      display: taskDetails.tasks.taskAssignedEmp.objectReason01 === null
                        ? 'none'
                        : 'block',
                    }}
                  >
                    <span style={{ opacity: '.5' }}>Reason-1: </span> {taskDetails.tasks.taskAssignedEmp.objectReason01 === null ? "No reason found" : taskDetails.tasks.taskAssignedEmp.objectReason01}
                  </Typography>
                  <Typography
                    variant="outlined"
                    sx={{
                      ...
                      display: taskDetails.tasks.taskAssignedEmp.objectReason02 === null
                        ? 'none'
                        : 'block', // Show or hide based on the condition
                    }}
                  >
                    <span style={{ opacity: '.5' }}>Reason-2: </span> {taskDetails.tasks.taskAssignedEmp.objectReason02 === null ? "No reason found" : taskDetails.tasks.taskAssignedEmp.objectReason02}
                  </Typography>
             ...
             /> */}
              ...
              <Grid container spacing={3} justifyContent="center" sx={{ position: 'relative', zIndex: '1000' }}>
                <Grid item xs={12} md={6} sx={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginTop: '40px' }}>
